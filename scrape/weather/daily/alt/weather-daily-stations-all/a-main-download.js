...
const url = `https://www.wunderground.com/history/daily/us/ca/los-angeles/${weatherStation}/date/${yearMonthDay}`;
...
const filename = `data/main-html/${weatherStation}|${yearMonthDay}.html`;
...
/* COMMANDS
node a-main-download.js KSMO 2025-01-07
node a-main-download.js KLAX 2025-01-07
node a-main-download.js KTOA 2025-01-07
