...
// File paths
const inputPath = path.join(__dirname, '../../../data/SOURCE/sce/sce/json/sce-extract.json');
const outputJsonPath = path.join(__dirname, '../../../data/PROCESSED/sce/sce/sce-data.json');
const outputCsvPath = path.join(__dirname, '../../../data/PROCESSED/sce/sce/sce-data.csv');
