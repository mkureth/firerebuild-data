...
const sourceFolder = path.join(__dirname, '../../../data/SOURCE/weather/day/main-csv');
const destinationFolder = path.join(__dirname, '../../../data/SOURCE/weather/day/main-processed');
