...
const outputFilePath = '../../../deploy/content/embed/palisades-fire-highest-wind/data/palisades-fire-highest-wind.json';

// Use null, 2 for pretty printing
fs.writeFileSync(outputFilePath, JSON.stringify(output));

console.log('Conversion complete. Output saved to palisades-fire-highest-wind.json');