...
const outputJsonPath = path.resolve(__dirname, '../../../deploy/content/palisades-fire-weather-report/assets/greatest-wind-speeds.json');
const outputCsvPath = path.resolve(__dirname, '../../../deploy/content/palisades-fire-weather-report/assets/greatest-wind-speeds.csv');
