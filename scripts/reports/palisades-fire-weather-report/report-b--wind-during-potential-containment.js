...
//const inputFilePath = '../../../deploy/content/palisades-fire-weather-report/assets/summary-ranged.json';
const inputFilePath = '../../../deploy/content/palisades-fire-weather-report/reports/wind-during-potential-containment/files/summary-ranged.json';
...
const outputFilePath = '../../../deploy/content/palisades-fire-weather-report/reports/wind-during-potential-containment/data/wind-during-potential-containment.json';

// Use null, 2 for pretty printing
fs.writeFileSync(outputFilePath, JSON.stringify(output));

console.log('Conversion complete. Output saved to wind-during-potential-containment.json');